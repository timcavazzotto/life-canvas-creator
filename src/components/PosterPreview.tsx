    ...
    <div ref={ref} className={`poster ${st.theme}`}>
      <div className="ph">
        <div>
          ...
          <div className="ph-title">PROJETO 80<sup>+</sup></div>
      ...
      <div className="pfoot">
        ...
        <div className="text-center"><div className="pfb-name">PROJETO 80<sup>+</sup></div><div className="pfb-tag">{t.tag[l]}</div></div>
